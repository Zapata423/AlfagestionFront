...
export default {
  ...
  data() {
    return {
      activeItem: 'registrar-estudiante',
      menuItems: [
        { id: 'registrar-estudiante', text: 'Registrar Estudiante Nuevo', href: '/registrar_estudiante' },
        { id: 'registrar-docente', text: 'Registrar Docente Nuevo', href: '/registrar_docente' },
